...
class Game extends Phaser.Scene {
    ...
    create() {
        ...
        var asteroids3 = this.physics.add.image(500, 200, 'asteroids3');
        ...
        this.physics.add.collider(this.ovni, asteroids);
        this.physics.add.collider(this.ovni, asteroids2);
        this.physics.add.collider(this.ovni, asteroids3);
        this.physics.add.collider(this.ovni, this.premios, this.pegou, null, this);
        //this.physics.add.collider(this.ovni, this.premios, this.pegou, null, this);

        this.passos = 70;

        this.add.text(10, 50, "Tempo:", {fontSize: '16px', fill: 'white'});
        this.add.text(10, 30, "Vidas:", {fontSize: '16px', fill: 'white'});

        this.pontos = 0;
        this.txtPontos = this.add.text(70, 50, this.pontos, {fontSize: '16px', fill: 'white'});

        this.vidas = 3;
        this.txtVidas = this.add.text(70, 30, this.vidas, {fontSize: '16px', fill: 'white'});
