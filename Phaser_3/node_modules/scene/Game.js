...
class Game extends Phaser.Scene {
    ...
    create() {
        ...
        this.physics.add.collider(asteroids, asteroids2);
        this.physics.add.collider(asteroids, asteroids3);
        this.physics.add.collider(asteroids2, asteroids3);
    ...
    update() {
        ...
        if(this.distancia == 5001){
            this.add.text(150, 250, "PARABÉNS, VOCE VENCEU", {fontSize: '32px', fill: 'green'});
